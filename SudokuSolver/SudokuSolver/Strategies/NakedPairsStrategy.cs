    ...
    class NakedPairsStrategy : ISudokuStrategy
    {
        ...
        public int[,] Solve(int[,] sudokuBoard)
        {
            for (int row = 0; row < sudokuBoard.GetLength(0); row++)
            {
                ...
                {
                    EliminateNakedPairFromeOthersInRow(sudokuBoard, row, col);
                    EliminateNakedPairFromeOthersInCol(sudokuBoard, row, col);
                    EliminateNakedPairFromeOthersInBlock(sudokuBoard, row, col);
                }
            }
            return sudokuBoard;
        }

       private void EliminateNakedPairFromeOthersInRow(int[,] sudokuBoard, int givenRow, int givenCol)
        {
        ...
        private void EliminateNakedPairFromeOthersInCol(int[,] sudokuBoard, int givenRow, int givenCol)
        {
        ...
        private void EliminateNakedPairFromeOthersInBlock(int[,] sudokuBoard, int givenRow, int givenCol)
        {
